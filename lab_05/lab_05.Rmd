...
```{r}
#load Tidyverse, Janitor and Lubridate
...
mingo%>%
  group_by(transaction_year)%>%
  summarise(total_shipments = sum(dosage_unit))
```
# 2012 the total pills was the lowest one, 2008 had the highest one and nearly 10 million. It was steadily increased since 2006, but suddently changed in 2009. 
