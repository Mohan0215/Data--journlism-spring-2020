...
```{r}
#Filler pills 
Maryland_city_pills_per_year <- arcos_county_pills_per_year %>%
...
```{r}
 # Build the chart  
  ...
  labs(x="Year", y="Total pills", title="opioids rising after 2011", subtitle = "Total pills shipped to Maryland by year", caption = "Source: DEA ARCOS database, via Washington Post") +
...
# No, it is different. Spiking year was different.
...
```{r}
state_pills_population_2012 <- state_pills_2012 %>%
  inner_join(state_population_2012)
```
